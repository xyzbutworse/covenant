...
export default function DocsPage() {
  return (
    <PageChrome eyebrow="PROTOCOL NOTES">
      ...
      <div className="docsLinks"><a href="https://docs.creditcoin.org/usc" target="_blank" rel="noreferrer">Creditcoin USC docs ↗</a><a href="https://github.com/gluwa/usc-testnet-bridge-examples" target="_blank" rel="noreferrer">Official examples ↗</a></div>
    </PageChrome>
  );
}
